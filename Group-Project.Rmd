...
3. Testing model using test / train 

```{r, message = FALSE, warning = FALSE}
set.seed(22)

#Importing libraries and implementing helper functions 
library(car)
library(lmtest)
library(boot)
library(caret)

#Provide brief description of what this function does 
