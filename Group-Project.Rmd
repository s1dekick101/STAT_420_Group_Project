...
Based upon the results of our test, we calculate a p-value of < 2.2e-16 meaning that we reject the `aic_model_log`; thus, the `aic_model_trans` model is preferred. 
