...
The larger AIC model is preferred.
...
#Implementing helper functions. Provide brief description of what this function does 
...
6. Using Model (Name of model we select here) to make `totalyearlycompensation` predictions 
